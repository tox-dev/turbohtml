...
URLs in a run of text and wraps each one in an anchor, leaving the surrounding characters untouched (email addresses
too, and phone numbers once you ask for them). It is the quickest way to turn a plain message into clickable HTML:
