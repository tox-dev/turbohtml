...
tested against existing libraries across the Python, Rust, C, C++, and Go ecosystems, exercised through their own test
suites. The aim was correctness as much as speed, checked against the tools that came before.
