...
and soupsieve-shaped search surface. :doc:`reference/clean` covers allowlist sanitizing, link rewriting, and
minification, and :doc:`reference/convert` translates CSS selectors to XPath 1.0. :doc:`reference/extract` and
:doc:`reference/structured-data` pull the article, its metadata, and the JSON-LD / Microdata / OpenGraph records out of
a page. :doc:`reference/build` constructs a tree in code, and :doc:`reference/serialize` renders one back to HTML,
