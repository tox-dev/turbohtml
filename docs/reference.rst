...
allowlist sanitizing and link-rewriting features, :doc:`reference/extract` the content-extraction namespace,
:doc:`reference/detect` the standalone encoding detector, and :doc:`reference/structured-data` the JSON-LD / Microdata /
