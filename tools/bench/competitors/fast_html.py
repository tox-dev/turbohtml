"""fast-html: assemble a lazy generator tree with underscore-mangled attributes and join it with ``render``."""
...
def build_e(count: int) -> None:
    """Build a ``<ul>`` of rows with fast-html's generator tags and render it to a string."""
