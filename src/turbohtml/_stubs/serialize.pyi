...
class Minify:
    ...
    @property
    def minify_css(self) -> CSSMinify | None: ...
...
def _minify_js(source: str, fold: bool, mangle: bool, on_error: str, /) -> str: ...
def _register_js_minify(js_minify_type: type[JSMinify], /) -> None: ...
def _register_css_minify(css_minify_type: type[CSSMinify], /) -> None: ...
def _register_render_configs(
    markdown_type: type, plaintext_type: type, html_type: type, canonical_type: type, /
) -> None: ...
