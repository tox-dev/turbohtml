...
class Node:
    ...
    def prune(self, selector: str, /) -> Self: ...
    def remove(self, selector: str, /) -> Self: ...
    def strip_tags(self, selector: str, /) -> Self: ...
    ...
    def serialize(self, options: Html | None = None, *, inner: bool = False) -> str: ...
    def serialize_iter(self, options: Html | None = None, *, inner: bool = False) -> Iterator[str]: ...
    def encode(self, encoding: str = "utf-8", options: Html | None = None, *, inner: bool = False) -> bytes: ...
...
class Document(Node):
    ...
    @property
    def encoding_confidence(self) -> Literal["certain", "tentative"] | None: ...
...
class Range:
    ...
    def surround_contents(self, new_parent: _NODE_T, /) -> _NODE_T: ...
...
def _build_element(tag: str, args: tuple[object, ...], mapping_type: type, /) -> Element: ...
def _decode(data: bytes, label: str, /) -> str: ...
def _detect(data: bytes, tld: str | None, /) -> tuple[str | None, bool, list[tuple[str, int]], bool] | None: ...
def _detect_rank(
    result: tuple[str | None, bool, list[tuple[str, int]], bool] | None,
...
@final
class _DetectStream:
    def __init__(self, tld: str | None, /) -> None: ...
    def feed(self, data: bytes, /) -> bool: ...
    def close(self) -> tuple[str | None, bool, list[tuple[str, int]], bool] | None: ...

def _detect_language(
    text: str, allowed: frozenset[str] | None, excluded: frozenset[str], threshold: float, /
) -> tuple[str | None, float, str | None, str | None]: ...
def _codec_label(name: str, /) -> tuple[bool, str] | None: ...
