...
static Py_UCS4 *copy_input_span(th_tree *tree, Py_ssize_t off, Py_ssize_t length) {
...
static Py_UCS4 *need_text(th_tree *tree, th_node *node) {
...
static void node_remove(th_node *child) {
...
static void node_insert_before(th_node *parent, th_node *child, th_node *ref) {
    if (ref == NULL) {
...
static int is_void_atom(uint16_t atom) {
    switch (atom) {
    case TH_TAG_AREA:
    case TH_TAG_BASE:
