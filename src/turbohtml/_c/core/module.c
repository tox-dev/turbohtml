...
static PyMethodDef html_methods[] = {
    ...
    {"_query_unique", turbohtml_query_unique, METH_O, NULL},
    {"_query_siblings", turbohtml_query_siblings, METH_VARARGS, NULL},
    {"_query_parents", turbohtml_query_parents, METH_VARARGS, NULL},
    {"_query_children", turbohtml_query_children, METH_VARARGS, NULL},
    {"_query_closest", turbohtml_query_closest, METH_VARARGS, NULL},
    {"_query_text", turbohtml_query_text, METH_VARARGS, NULL},
    {"_query_attr", turbohtml_query_attr, METH_VARARGS, NULL},
    {"_query_has_class", turbohtml_query_has_class, METH_VARARGS, NULL},
    {"_query_add_class", turbohtml_query_add_class, METH_VARARGS, NULL},
    {"_query_remove_class", turbohtml_query_remove_class, METH_VARARGS, NULL},
    ...
    {"_phone_e164", turbohtml_phone_e164, METH_VARARGS, NULL},
    {"_phone_regions", turbohtml_phone_regions, METH_O, NULL},
    {"_linkify_fold", turbohtml_linkify_fold, METH_VARARGS, NULL},
    ...
    {"_url_scrub", turbohtml_url_scrub, METH_O, NULL},
    {"_url_variant_key", turbohtml_url_variant_key, METH_O, NULL},
