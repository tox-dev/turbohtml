...
:mod:`turbohtml.query` matching facade; and the :func:`turbohtml.convert.css_to_xpath` translator. The
...
class SelectorSyntaxError(ValueError):
    ...
    :meth:`~turbohtml.Node.closest`, by the :mod:`turbohtml.query` matching helpers, and by
